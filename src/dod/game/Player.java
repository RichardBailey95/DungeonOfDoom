...
public class Player implements GameItemConsumer {
     ...
     */
    public Player(String name, Location location, PlayerListener listener, int playerID) {
	this.name = name;
    ...
    //Notifies the player when a change to the map happens
    public void change() {
	...
	public void disconnectPlayer(int playerID) {
		this.listener.disconnectPlayer(playerID);
	}
	...
	public void addLantern() {
		this.listener.hasLantern();		
	}

	public void sendWhisper(String message) {
		this.listener.sendWhisper(message);
	}
}